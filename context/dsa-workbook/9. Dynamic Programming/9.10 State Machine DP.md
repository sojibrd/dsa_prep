...
**Demo: Best Time to Buy and Sell Stock with Cooldown** — [LC 309](https://leetcode.com/problems/best-time-to-buy-and-sell-stock-with-cooldown/) _(Medium — Facebook/Google High)_

**Statement (Demo):** integer array `prices` দেওয়া — stock কেনাবেচা করে সর্বোচ্চ কত লাভ করা সম্ভব বলুন। নিয়ম: ১ দিন cooldown থাকবে (বিক্রি করার ঠিক পরের দিন কিনতে পারবেন না)।
উদাহরণ: `prices=[1,2,3,0,2]` → `3` (buy on day 1, sell on day 2, cooldown on day 3, buy on day 4, sell on day 5) | ⚡ `prices.length ≤ 5000`
